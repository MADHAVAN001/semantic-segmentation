...
class FCN:
    ...
    def __init__(self, sparsify=False, sparsify_params=None):
        self.is_pruning_enabled = sparsify
        if self.is_pruning_enabled:
            self.prune_params = {'pruning_schedule':
                                     sparsity.PolynomialDecay(initial_sparsity=sparsify_params[0],
                                                              final_sparsity=sparsify_params[1],
                                                              begin_step=sparsify_params[2],
                                                              end_step=sparsify_params[3],
                                                              frequency=sparsify_params[4])}
